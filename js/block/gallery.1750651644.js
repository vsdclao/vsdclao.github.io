...
$('.gallery-item').die('click').live('click', function(e) {
    ...
    $(gid).on('slide', function (event, index, slide) {
        if(!$galleryItem.find('a').is('[data-gallery-like="N"]')) $('.gallery-frame .blueimp-gallery a.gallery-like').removeAttr('data-like').addClass('hide');
		...
		var setSlideIcon = function() {
            ...
            if(!$galleryItem.find('a').is('[data-gallery-like="N"]')) {
